...
Now that we have our build task setup, we can use [Cartero Express hook](https://github.com/rotundasoftware/cartero-express-hook) to get our assets included in our views. Let's add the hook into our middleware stack in `server.js`.
